...
export async function GET(req: NextRequest) {
  ...
  // SVG icon paths
  const dateVB = "0 0 60.88 60.36";
  const bringVB = "0 0 45.92 61.57";
  const msgVB = "0 0 60.02 60.02";

  return new ImageResponse(
    (
      <div style={{ width: 1200, height: 630, background: "#F5EFE6", display: "flex", position: "relative", fontFamily: "Arial Black, Arial, sans-serif" }}>
        <img src={plate} style={{ position: "absolute", right: 0, top: 0, width: 480, height: 630, objectFit: "cover" }} />

        <div style={{ position: "absolute", left: 72, top: 48, bottom: 44, width: 590, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {when ? (
              <div style={{ display: "flex", alignItems: "center", gap: 14, height: 48 }}>
                <svg width="28" height="28" viewBox={dateVB} fill="none">
            ...
            {why ? (
              <div style={{ display: "flex", alignItems: "center", gap: 14, height: 48 }}>
                <svg width="28" height="28" viewBox={msgVB} fill="none">
                  ...
                  <path fill={ORANGE} d="M16.67,24.45h26.68c.29,0,.58-.12.79-.33.21-.21.33-.49.33-.79s-.12-.58-.33-.79c-.21-.21-.49-.33-.79-.33h-26.68c-.29,0-.58.12-.79.33-.21.21-.33.49-.33.79s.12.58.33.79c.21.21.49.33.79.33Z"/>
                  <path fill={ORANGE} d="M16.67,28.9h26.68c.29,0,.58-.12.79-.33.21-.21.33-.49.33-.79s-.12-.58-.33-.79c-.21-.21-.49-.33-.79-.33h-26.68c-.29,0-.58.12-.79.33-.21.21-.33.49-.33.79s.12.58.33.79c.21.21.49.33.79.33Z"/>
                  <path fill={ORANGE} d="M37.79,31.12h-15.56c-.29,0-.58.12-.79.33-.21.21-.33.49-.33.79s.12.58.33.79c.21.21.49.33.79.33h15.56c.29,0,.58-.12.79-.33.21-.21.33-.49.33-.79s-.12-.58-.33-.79c-.21-.21-.49-.33-.79-.33Z"/>
                </svg>
